...
namespace SIGAD.BlazorApp.Models
{
    ...
    {
        [Required(ErrorMessage = "El Id es un número requerido.")]
        [Range(1, 100, ErrorMessage = "El Id debe ser un número entre 1 y 100.")]
        ...
        [Range(0, 100.00, ErrorMessage = "El valor debe estar entre 0.00 y 100.00.")]
